---
name: "source-command-ape-archive"
description: "Archive a completed change in the experimental workflow"
---

# source-command-ape-archive

Use this skill when the user asks to run the migrated source command `ape-archive`.
...
2. **Check artifact completion status**
   ...
   Run `apeworkflow status --change "<name>" --json` to check artifact completion.
...
4. **Assess delta spec sync state**
   ...
   **If delta specs exist:**
   - Compare each delta spec with its corresponding main spec at `apeworkflow/specs/<capability>/spec.md`
...
- Use artifact graph (apeworkflow status --json) for completion checking
