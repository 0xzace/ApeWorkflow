---
name: feedback
description: Collect and submit user feedback about ApeWorkflow with context enrichment and anonymization.
license: MIT
...
Help the user submit feedback about ApeWorkflow.
...
5. **Submit on confirmation**
   ...
   - Format: `apeworkflow feedback "title" --body "body content"`
