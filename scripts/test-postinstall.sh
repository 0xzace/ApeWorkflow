...
echo "======================================"
echo "Testing ApeWorkflow Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_APEWORKFLOW_NO_COMPLETIONS="${APEWORKFLOW_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset APEWORKFLOW_NO_COMPLETIONS
...
echo "Test 3: APEWORKFLOW_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export APEWORKFLOW_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_APEWORKFLOW_NO_COMPLETIONS" ]; then
  export APEWORKFLOW_NO_COMPLETIONS="$ORIGINAL_APEWORKFLOW_NO_COMPLETIONS"
else
  unset APEWORKFLOW_NO_COMPLETIONS
fi
