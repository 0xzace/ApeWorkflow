...
Configure ApeWorkflow to generate artifacts in languages other than English.

## Quick Setup

Add a language instruction to your `apeworkflow/config.yaml`:
...
apeworkflow instructions proposal --change my-change
