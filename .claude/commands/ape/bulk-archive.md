...
1. **Get active changes**
   ...
   Run `apeworkflow list --json` to get all active changes.
...
3. **Batch validation - gather status for all selected changes**
   ...
   a. **Artifact status** - Run `apeworkflow status --change "<name>" --json`
...
8. **Execute archive for each confirmed change**
   ...
   a. **Sync specs** if delta specs exist:
      - Use the apeworkflow-sync-specs approach (agent-driven intelligent merge)
...
- Preserve .apeworkflow.yaml when moving to archive
