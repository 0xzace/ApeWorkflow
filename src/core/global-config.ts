...
// Constants
export const GLOBAL_CONFIG_DIR_NAME = 'apeworkflow';
export const GLOBAL_CONFIG_FILE_NAME = 'config.json';
export const GLOBAL_DATA_DIR_NAME = 'apeworkflow';
 ...
 *
 * - All platforms: $XDG_CONFIG_HOME/apeworkflow/ if XDG_CONFIG_HOME is set
 * - Unix/macOS fallback: ~/.config/apeworkflow/
 * - Windows fallback: %APPDATA%/apeworkflow/
 */
 ...
 *
 * - All platforms: $XDG_DATA_HOME/apeworkflow/ if XDG_DATA_HOME is set
 * - Unix/macOS fallback: ~/.local/share/apeworkflow/
 * - Windows fallback: %LOCALAPPDATA%/apeworkflow/
 */
