...
export function getProjectSchemasDir(projectRoot: string): string {
  return path.join(projectRoot, 'apeworkflow', 'schemas');
}
 ...
 * 1. Project-local: <projectRoot>/apeworkflow/schemas/<name>/schema.yaml
 * 2. User override: ${XDG_DATA_HOME}/apeworkflow/schemas/<name>/schema.yaml
