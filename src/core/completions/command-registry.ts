...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env APEWORKFLOW_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'set',
    description: 'Set checked-in ApeWorkflow metadata',
    flags: [],
    subcommands: [
      {
        name: 'change',
    ...
    subcommands: [
      {
        ...
        flags: [
          ...
          {
            name: 'tools',
            description: 'Install ApeWorkflow skills for agents (all, none, or comma-separated tool IDs)',
            takesValue: true,
          },
          COMMON_FLAGS.json,
          COMMON_FLAGS.noInteractive,
      ...
      {
        name: 'list',
        description: 'List known ApeWorkflow workspaces',
        flags: [
          COMMON_FLAGS.json,
        ],
      },
      ...
      {
        name: 'update',
        description: 'Refresh workspace-local ApeWorkflow guidance and agent skills',
        acceptsPositional: true,
  ...
  {
    name: 'change',
    description: 'Manage ApeWorkflow change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage ApeWorkflow specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
