...
describe('interactive utilities', () => {
  let originalApeWorkflowInteractive: string | undefined;
  let originalCI: string | undefined;
  let originalStdinIsTTY: boolean | undefined;

  beforeEach(() => {
    // Save original environment
    originalApeWorkflowInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalApeWorkflowInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalApeWorkflowInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
