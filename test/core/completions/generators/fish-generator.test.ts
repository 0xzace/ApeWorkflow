  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      const commands: CommandDefinition[] = [
        {
          name: 'init',
          description: 'Initialize ApeWorkflow',
          flags: [],
        },
      ];
      ...
      expect(script).toContain('# Fish completion script for ApeWorkflow CLI');
      expect(script).toContain('function __fish_apeworkflow');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_apeworkflow_using_subcommand');
      expect(script).toContain('function __fish_apeworkflow_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c apeworkflow");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize ApeWorkflow'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_apeworkflow_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_apeworkflow_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_apeworkflow_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_apeworkflow_items');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_apeworkflow_schemas');
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_apeworkflow_changes');
      expect(script).toContain('apeworkflow __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_apeworkflow_specs');
      expect(script).toContain('apeworkflow __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_apeworkflow_items');
      expect(script).toContain('__fish_apeworkflow_changes');
      expect(script).toContain('__fish_apeworkflow_specs');
    });
